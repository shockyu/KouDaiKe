...
#import "YKLNetworkingMiaoSha.h"

@implementation YKLNetworkingMiaoSha
                               ...
                               failure:(void (^)(NSError *error))failure
{
    ...
    [self POSTMiaoSha:@"" parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
