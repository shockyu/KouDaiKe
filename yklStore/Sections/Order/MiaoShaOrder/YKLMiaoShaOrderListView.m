...
@implementation YKLMiaoShaOrderListView
...
//    self.orderID = @"6";
    ...
    //1.待兑换 2.已兑换
    [YKLNetworkingMiaoSha getOrderListWithUserID:self.orderID Status:status Success:^(NSArray *winnerList) {
