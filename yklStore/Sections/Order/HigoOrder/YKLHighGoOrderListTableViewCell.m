//
//  YKLHighGoOrderListTableViewCell.m
//  yklStore
//
...
@implementation YKLHighGoOrderListTableViewCell
...
//        self.mobleLabel.text = @"XXXXXX店铺";
        ...
        self.actTitleLabel.text = @"活动类型：一元抽奖";
        self.actTitleLabel.textColor = [UIColor blackColor];
        self.actTitleLabel.font = [UIFont systemFontOfSize:13];
        ...
        NSString *price = @"398";
        self.priceLabel.text = [NSString stringWithFormat:@"共%@参与",price];
        ...
        NSString *lowestPrice = @"3";
        self.lowestPriceLabel.text = [NSString stringWithFormat:@"已成功%@个产品",lowestPrice];
        self.lowestPriceLabel.textColor = [UIColor flatLightRedColor];
        self.lowestPriceLabel.font = [UIFont systemFontOfSize:12];
...
//              self.lowestPriceLabel.backgroundColor = [UIColor blueColor];
        ...
        self.peducePriceLabel.text = @"查看详情";
        self.peducePriceLabel.textColor = [UIColor flatLightRedColor];
        self.peducePriceLabel.font = [UIFont systemFontOfSize:12];
