...
@implementation YKLDuoBaoOrderListMainView
...
- (void)getOrderslist:(NSString *)status{
    ...
    [YKLNetworkingDuoBao getIndianaOrderCenterWithUserID:[YKLLocalUserDefInfo defModel].userID Success:^(NSArray *orderListModel) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (d){
        ...
        cell.lowestPriceLabel.text = [NSString stringWithFormat:@"共%@人获奖",self.model.sucNum];
        cell.priceLabel.text = [NSString stringWithFormat:@"共%@人参与",self.model.joinNum];
        cell.actTitleLabel.text = @"活动类型：口袋夺宝";
    }
    return cell;
}
