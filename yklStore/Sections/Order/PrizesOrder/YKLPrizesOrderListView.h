...
@class YKLPrizesOrderListView;
@protocol YKLPrizesOrderListViewDelegate <NSObject>

- (void)consumerOrderListView:(YKLPrizesOrderListView *)listView didSelectOrder:(YKLHighGoOrderDetailModel *)model;

@end

@interface YKLPrizesOrderListView : UIView<UITableViewDataSource, MUILoadMoreTableViewDelegate>

@property (nonatomic, assign) id<YKLPrizesOrderListViewDelegate> delegate;
