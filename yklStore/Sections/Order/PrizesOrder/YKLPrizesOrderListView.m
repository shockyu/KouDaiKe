...
@implementation YKLPrizesOrderListView
...
- (void)getOrderslist:(NSString *)status{
    ...
    //1.中奖 2.中奖未领奖 3.已兑换
    [YKLNetworkingPrizes getRedWinnerWithRID:self.orderID Status:status Success:^(NSArray *winnerList) {
...
//    [cell updateWithFanModel:self.model];
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%@",self.model.prizeName];
