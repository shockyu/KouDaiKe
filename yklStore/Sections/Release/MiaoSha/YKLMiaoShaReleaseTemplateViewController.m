...
- (void)getActivitylist{
    ...
    [YKLNetworkingMiaoSha getMiaoShaTemplateWithTempCode:self.tempCode
...
- (void)cateBtnClicked:(UIButton *)aBtn
{
    ...
    YKLMiaoShaReleaseTemplateView *templateView = (YKLMiaoShaReleaseTemplateView *)[self.scrollView viewWithTag:kTemplateViewTag];
