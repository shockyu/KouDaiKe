//
//  YKLSuDingActivityUserListViewController.m
//  yklStore
//
...
@interface YKLSuDingActivityUserListViewController ()<UITableViewDataSource, MUILoadMoreTableViewDelegate>
...
@implementation YKLSuDingActivityUserListViewController
...
//    self.goodID = @"6";
    ...
    [YKLNetWorkingSuDing getGoodsJoinerWithGoodsID:self.goodID Success:^(NSArray *userList) {
