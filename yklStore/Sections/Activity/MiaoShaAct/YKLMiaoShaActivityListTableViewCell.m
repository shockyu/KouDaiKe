//
//  YKLMiaoShaActivityListTableViewCell.m
//  yklStore
//
...
@implementation YKLMiaoShaActivityListTableViewCell
...
//        self.startTimeLabel.backgroundColor = [UIColor redColor];
        ...
        self.activityNameLabel.text = @"秒杀";
