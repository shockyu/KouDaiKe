//
//  YKLPrizesActivityListTableViewCell.m
//  yklStore
//
...
@implementation YKLPrizesActivityListTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.originalLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.titleLabel.origin.x, self.titleLabel.bottom, 75, 18)];
        self.originalLabel.text = @"奖品中奖人数";
        ...
        self.originalPriceLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.originalLabel.right+60, self.originalLabel.top, 90, 18)];
        self.originalPriceLabel.textAlignment = NSTextAlignmentCenter;
        self.originalPriceLabel.text = @"XXX人";
        self.originalPriceLabel.textColor = [UIColor flatLightRedColor];
        ...
        self.bargainLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.originalLabel.left, self.originalLabel.bottom, 75, 18)];
        self.bargainLabel.text = @"流量中奖人数";
        ...
        self.bargainPriceLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.bargainLabel.right+60, self.bargainLabel.top, 90, 18)];
        self.bargainPriceLabel.textAlignment = NSTextAlignmentCenter;
        self.bargainPriceLabel.text = @"XXX人";
        self.bargainPriceLabel.textColor = [UIColor flatLightRedColor];
        self.bargainPriceLabel.font = [UIFont systemFontOfSize:12];
        //        self.bargainLabel.backgroundColor = [UIColor blueColor];
        [self.bgView addSubview:self.bargainPriceLabel];
        
        self.endTimeLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.titleLabel.origin.x, self.bargainLabel.bottom, 130, 18)];
...
//        self.endTimeLabel.backgroundColor = [UIColor redColor];
        ...
        self.activityLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.endTimeLabel.right, self.bargainLabel.bottom, 50, 18)];
...
//        self.activityLabel.backgroundColor = [UIColor redColor];
        ...
        self.activityNameLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.activityLabel.right, self.bargainLabel.bottom, 50, 18)];
        self.activityNameLabel.text = @"口袋红包";
...
//        self.participantNubLabel.backgroundColor = [UIColor blueColor];
        ...
        self.participantLabel.text = @"奖品红包剩余";
...
//        self.participantLabel.backgroundColor = [UIColor redColor];
        ...
        UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(self.participantLabel.right, self.lineView.bottom+15, 0.5, 30)];
...
//        self.successLabel.backgroundColor = [UIColor redColor];
        ...
        lineView = [[UIView alloc]initWithFrame:CGRectMake(self.successLabel.right, self.lineView.bottom+15, 0.5, 30)];
        lineView.backgroundColor = [UIColor lightGrayColor];
        [self.bgView addSubview:lineView];
...
//        //2,已完成
//        self.againReleaseBtn = [UIButton buttonWithType:UIButtonTypeCustom];
//        self.againReleaseBtn.titleLabel.font = [UIFont systemFontOfSize:12];
//        [self.againReleaseBtn setTitle:@"再次发布" forState:UIControlStateNormal];
//        [self.againReleaseBtn setTitleColor:[UIColor whiteColor]forState:UIControlStateNormal];
//        [self.againReleaseBtn setTitleColor:[UIColor lightGrayColor]forState:UIControlStateHighlighted];
//        self.againReleaseBtn.backgroundColor = [UIColor flatLightRedColor];
//        self.againReleaseBtn.layer.cornerRadius = 5;
//        self.againReleaseBtn.layer.masksToBounds = YES;
//        self.againReleaseBtn.frame = CGRectMake(205,self.lineView.bottom+10,100,self.bgView.height-self.lineView.bottom-20);
//        //        [self.againReleaseBtn addTarget:self action:@selector(againReleaseBtnClick:) forControlEvents:UIControlEventTouchUpInside];
//        [self.bgView addSubview: self.againReleaseBtn];
