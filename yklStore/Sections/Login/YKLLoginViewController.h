...
@interface YKLLoginViewController : YKLUserBaseViewController

@property (nonatomic, assign) YKLUserType curUserType;

@property (nonatomic, strong) NSMutableDictionary *dicUserViews;
@property (nonatomic, strong) NSMutableArray *userViewQueue;

//@property (nonatomic, strong) UIView *barTitleView;
//@property (nonatomic, strong) UIButton *loginTitleBtn;
//@property (nonatomic, strong) UIButton *registTitleBtn;
...
@property (nonatomic, strong) UITextField *agentIDField;        //服务识别码
@property (nonatomic, strong) UITextField *agentNameField;      //服务商名称
@property (nonatomic, strong) UITextField *agentMobileField;    //服务商电话
