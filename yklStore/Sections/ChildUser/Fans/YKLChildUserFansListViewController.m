//
//  YKLChildUserFansListViewController.m
//  yklStore
//
//  Created by 肖震宇 on 16/6/17.
...
@interface YKLChildUserFansListCell : UITableViewCell
{
...
@implementation YKLChildUserFansListCell
...
@interface YKLChildUserFansListViewController ()<UITableViewDataSource, MUILoadMoreTableViewDelegate>
...
@implementation YKLChildUserFansListViewController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[YKLChildUserFansListCell class] forCellReuseIdentifier:@"cell"];
...
- (void)requestMoreProduct {
    ...
    [YKLNetworkingConsumer getChildAccountWithPid:[YKLLocalUserDefInfo defModel].userID Act:@"fans" IsShow:@"0" success:^(NSDictionary *dict) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    YKLChildUserFansListCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
    cell.backgroundColor = [UIColor clearColor];
    
    NSDictionary *tempDict = self.records[indexPath.row];
    cell.gsNameLabel.text = [tempDict objectForKey:@"shop_name"];
    cell.fansNumLabel.text = [tempDict objectForKey:@"fans"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    fansVC.shopID = [tempDict objectForKey:@"id"];
