...
@property (nonatomic, assign) float boarderSize;        //default is 1.0
@property (nonatomic, assign) float cornerRadius;       //default is 3.0

@property (nonatomic, assign) UIFont *font;         //default is [UIFont systemFontOfSize:14]
