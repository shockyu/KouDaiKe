...
//#import "MPSUserStoreViewController.h"
...
//            [debugInfo appendFormat:@"服务器返回签名验证错误！！！\n"];
            [UIAlertView showInfoMsg:@"微信出问题啦，微信团队正在抢修中，建议使用其他支付方式"];
        }
    }else{
        last_errcode = 2;
...
//    NSString *orderno   = [NSString stringWithFormat:@"%ld",time(0)];
    ...
    [packageParams setObject: orderNub           forKey:@"out_trade_no"];//商户订单号
