...
- (UIImageView *)animationImageView {
    if (!_animationImageView) {
        _animationImageView = [[UIImageView alloc] initWithFrame:CGRectMake(62+10, -14+20, 49, 74-25)];
        NSArray *images = @[[UIImage imageNamed:@"loading-01.png"],
                            [UIImage imageNamed:@"loading-02.png"],
                            [UIImage imageNamed:@"loading-03.png"],
                            [UIImage imageNamed:@"loading-04.png"],
                            [UIImage imageNamed:@"loading-05.png"],
                            [UIImage imageNamed:@"loading-06.png"],
                            [UIImage imageNamed:@"loading-07.png"],
                            [UIImage imageNamed:@"loading-08.png"],
                            [UIImage imageNamed:@"loading-09.png"],
...
- (UILabel *)tipsLabel {
    if (!_tipsLabel) {
        _tipsLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMidX(self.bounds) - 30, 15, 80+50, 20)];
        _tipsLabel.text = @"放大你的生意";
